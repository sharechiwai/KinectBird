...
export class Renderer {
        ...
        _.forEach(players, function (player, index) {
            ...
            if (player.state !== DEAD) {
                ...
                if (player.overheadText) {
                    ...
                    context.fillText(player.overheadText, 0.0, -0.7);
                    context.restore();
                }
            }
            ...
            context.scale(INTERFACE_TEXT_SCALING / self.aspectRatio, -INTERFACE_TEXT_SCALING);
            context.textAlign = 'center';
            context.fillText(player.currentScore, 0.0, 0.0);
            context.restore();
    ...
    renderInterface(gameState) {
        ...
        context.scale(INTERFACE_TEXT_SCALING / this.aspectRatio, -INTERFACE_TEXT_SCALING);
        context.textAlign = 'left';
